    ...
    snap = {
        ...
        "elements": [
            {"tag":"button","role":"button","cls":["btn","primary"],"props":{
                ...
                "letter-spacing":"normal","text-transform":"none","margin":"0px","padding":"8px 16px","padding-left":"16px","gap":"0px","row-gap":"0px","column-gap":"0px",
            ...
            {"tag":"p","role":None,"cls":[],"props":{
                ...
                "letter-spacing":"normal","text-transform":"none","margin":"0px 0px 16px","padding":"0px","padding-left":"0px","gap":"0px","row-gap":"0px","column-gap":"0px",
